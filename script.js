document.addEventListener('DOMContentLoaded', function() {
    ...
    createButtons.forEach(function(createButton) { //cria os botões (primeira tela)  
    ...
    saveButton.addEventListener('click', function() { //evento para click do botao de salvar (primera tela)
        const nomeInput = document.getElementById('nome');
        const tagInput = document.getElementById('tag');
